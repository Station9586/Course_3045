...
cv2.imwrite('Result image/Ch13_11_sobel.jpg', dst_sobel)
cv2.imwrite('Result image/Ch13_11_scharr.jpg', dst_scharr)
cv2.imwrite('Result image/Ch13_11_laplacian.jpg', dst_lap)
